...
namespace ExamOnline.Controllers
{
    ...
    [ApiController]
    public class ExaminationController : BaseController<Examination, ExaminationRepository>
    {
        readonly ExaminationRepository _repository;
        readonly MyContext _context;
        public ExaminationController(ExaminationRepository repository, MyContext myContext) : base(repository)
        {
